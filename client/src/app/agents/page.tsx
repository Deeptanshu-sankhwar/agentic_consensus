...
// Main component for managing agents configuration
export default function AgentsPage() {
  ...
  return (
    <>
      <Head>
        <title>Agent Configuration - Agent Launchpad</title>
      ...
      <div className="min-h-screen bg-[#101014] text-gray-100 flex flex-col items-center justify-center p-8 pl-0">
      ...
      {isModalOpen && <AddAgentModal onAddAgent={addAgent} onClose={closeModal} />}
